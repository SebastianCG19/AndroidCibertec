package com.example.practiexam
...
import com.example.practiexam.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAction.setOnClickListener {
            ...
            //Toast.makeText(this,textoToShow, Toast.LENGTH_LONG).show()


            var ep1 = binding.etEp1.text.toString().toInt()
